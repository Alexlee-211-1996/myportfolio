...
const HERO_TEXTS = [
  "Full-Stack Engineer | Enterprise Experience",
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 3xl:gap-16 4xl:gap-20 items-center">
            ...
            <Reveal delay={0.15}>
              <div className="max-w-2xl mx-auto md:mx-0">
                <p className="text-lg leading-relaxed text-foreground/80">
                  I help companies build fast, scalable, and production-ready web applications — from idea to deployment. I'm a full-stack developer with enterprise experience across global consulting firms and cybersecurity technology companies. I combine strong technical execution with business awareness, ensuring that what we build is not just functional — but reliable, maintainable, and built to scale.
                </p>
              </div>
            </Reveal>
          ...
          <Reveal delay={0.25}>
            <div className="flex items-center justify-center">
              <img
                src="/profile.png"
                alt="Akirajei - Full-Stack Engineer"
                className="w-full h-auto max-w-sm sm:max-w-md md:max-w-lg 3xl:max-w-xl 4xl:max-w-2xl rounded-2xl object-cover shadow-2xl"
              />
            </div>
          </Reveal>
        </div>
