              ...
              <div className="relative z-10">
                ...
                <div className="space-y-4">
                  <p className="text-foreground/80 leading-relaxed text-lg">
                    ...
                    with enterprise experience across global consulting firms and cybersecurity technology companies. I combine strong technical execution with business awareness, ensuring that what we build is not just functional — but reliable, maintainable, and built to scale.
                  </p>
                </div>
              </div>
            ...
            <div className="h-full neobrutalist-card p-8 relative group hover:-translate-y-1 transition-all duration-300 bg-card border border-border">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="space-y-2 relative pl-4 border-l-2 border-secondary/20">
                  ...
                  <p className="text-foreground font-semibold">Master's Degree</p>
